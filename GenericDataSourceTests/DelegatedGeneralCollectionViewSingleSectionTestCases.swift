//
//  DelegatedGeneralCollectionViewSingleSectionTestCases.swift
//  GenericDataSource
//
...
class DelegatedGeneralCollectionViewSingleSectionTestCases: XCTestCase {
    ...
    override func setUp() {
        ...
        dataSource  = CompositeDataSource(sectionType: .single)
    ...
    func testScrollView() {
        ...
        // call configure
        dataSource.ds_collectionView(tableView, didSelectItemAt: IndexPath(row: 50, section: 0))
    }
    ...
    func testDequeueCell() {
        ...
        textReportsDataSource.configure = { collectionViews in
            ...
            for collectionView in collectionViews {
                ...
                XCTAssertEqual(IndexPath(row: 50, section: 0), self.tableView.indexPath)
    ...
    func testNumberOfItems() {
        ...
        textReportsDataSource.configure = { collectionViews in
            ...
            for collectionView in collectionViews {
                ...
                let items = collectionView.ds_numberOfItems(inSection: 7)
    ...
    func testInsertSections() {
        ...
        textReportsDataSource.configure = { collectionViews in
            ...
            for collectionView in collectionViews {
                let indexSet = IndexSet(integersIn: NSMakeRange(0, 10).toRange()!)
    ...
    func testMoveItem() {
        ...
        textReportsDataSource.configure = { collectionViews in
            ...
            for collectionView in collectionViews {
                ...
                XCTAssertEqual(IndexPath(row: 65, section: 0), self.tableView.indexPath)
                XCTAssertEqual(IndexPath(row: 100, section: 0), self.tableView.toIndexPath)
    ...
    func testIndexPathForCell() {
        ...
        textReportsDataSource.configure = { collectionViews in
            ...
            for collectionView in collectionViews {
                ...
                self.tableView.indexPath = IndexPath(row: 50, section: 0)
    ...
    func testIndexPathsForVisibleItems() {
        ...
        textReportsDataSource.configure = { collectionViews in
            ...
            for collectionView in collectionViews {
                self.tableView.indexPaths = [IndexPath(row: 50, section: 0), IndexPath(row: 100, section: 0)]
                let indexPaths = collectionView.ds_indexPathsForVisibleItems()

                XCTAssertEqual([IndexPath(row: 0, section: 0), IndexPath(row: 50, section: 0)], indexPaths)
    ...
    func testLocalIndexPathForGlobalIndexPath() {
        ...
        textReportsDataSource.configure = { collectionViews in
            ...
            for collectionView in collectionViews {
                let indexPath = collectionView.ds_localIndexPathForGlobalIndexPath(IndexPath(row: 51, section: 0))
                
                XCTAssertEqual(IndexPath(row: 1, section: 0), indexPath)
    ...
    func testGlobalIndexPathForLocalIndexPath() {
        ...
        textReportsDataSource.configure = { collectionViews in
            ...
            for collectionView in collectionViews {
                ...
                XCTAssertEqual(IndexPath(row: 52, section: 0), indexPath)
